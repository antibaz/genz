...
class CreateModalsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Modals", 'modals', 'name', 'fa-laptop', [
            ["name", "Имя", "Name", false, "", 0, 256, true],
            ["phone", "Телефон", "Mobile", false, "", 0, 20, true],
            ["comment", "Описание заявки", "Textarea", false, "", 0, 0, true],
        ]);
