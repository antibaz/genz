...
class CreateTopsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Tops", 'tops', 'title', 'fa-cube', [
            ["title", "Название пункта меню", "String", false, "", 0, 256, true],
            ["slug", "Ссылка", "String", false, "", 0, 256, true],
            ["sort_top", "Сортировка", "Integer", false, "", 1, 1000, false],
        ]);
