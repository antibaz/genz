...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		...
		<div class="col-md-1 actions">
			@la_access("Tops", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/tops/'.$top->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Tops", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.tops.destroy', $top->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/tops') }}" data-toggle="tooltip" data-placement="right" title="Back to Tops"><i class="fa fa-chevron-left"></i></a></li>
